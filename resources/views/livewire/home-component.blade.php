                        ...
                        @foreach ($services as $service)
                            <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                                ...
                                <a class="g-list" href="{{route('home.service_details',['service_slug'=>$service->slug])}}">
                                    <div class="img-hover">
                                        <img src="{{asset('images/services/thumbnails')}}/{{$service->image}}"
                                            alt="{{$service->name}}"
                                ...
                                <li>
                                    <a href="{{route('home.services_by_category',['category_slug'=>$scategory->slug])}}">
                                        <div class="item-service-line">
                                            <i class="fa">
                                                <img class="icon-img" alt="{{$scategory->name}}"
        ...
        <div>
            ...
            <div id="boxes-carousel">
                @foreach ($aservices as $aservice)
                    <div>
                        <a class="g-list" href="{{route('home.service_details', ['service_slug'=>$aservice->slug])}}"></a>
                            <div class="img-hover">
