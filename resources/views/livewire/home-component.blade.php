                    ...
                    <div class="col-md-12">
                        <ul id="sponsors" class="tooltip-hover">
                            ...
                            <li data-toggle="tooltip" title=""
                                data-original-title="Geyser">
                                <a href="servicesbycategory/14.html">
                                    <img src="{{asset('images/sercat/service-icon.png')}}"
                                        alt="Geyser">
                                </a>
                            </li>
                            <li data-toggle="tooltip" title=""
                                data-original-title="Car">
                                <a href="servicesbycategory/15.html">
                                    <img src="{{asset('images/sercat/service-icon.png')}}"
                                        alt="Car">
                                </a>
                            </li>
                            <li data-toggle="tooltip" title=""
                                data-original-title="Document">
                                <a href="servicesbycategory/16.html">
                                    <img src="{{asset('images/sercat/service-icon.png')}}"
                                        alt="Document">
                                </a>
                            </li>
                            <li data-toggle="tooltip" title=""
                                data-original-title="Movers &amp; Packers">
                                <a href="servicesbycategory/17.html">
                                    <img src="{{asset('images/sercat/service-icon.png')}}"
                                        alt="Movers &amp; Packers">
                                </a>
                            </li>
                            <li data-toggle="tooltip" title=""
                                data-original-title="Home Automation">
                                <a href="servicesbycategory/18.html">
                                    <img src="{{asset('images/sercat/service-icon.png')}}"
                                        alt="Home Automation">
                                </a>
                            </li>
                            ...
                            <a class="g-list" href="service-details/ac-dry-servicing.html">
                                ...
                                <div class="info-gallery">
                                    ...
                                    <div class="content-btn">
                                        <a href="service-details/ac-dry-servicing.html"
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                            ...
                            <a class="g-list" href="service-details/ac-installation.html">
                                ...
                                <div class="info-gallery">
                                    ...
                                    <p>AC Installation</p>
                                    <div class="content-btn">
                                        <a href="service-details/ac-installation.html"
                                            class="btn btn-primary">Book Now</a></div>
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                            ...
                            <a class="g-list" href="service-details/ac-gas-refill.html">
                                ...
                                <div class="info-gallery">
                                    ...
                                    <p>AC Gas Refill</p>
                                    <div class="content-btn">
                                        <a href="service-details/ac-gas-refill.html"
                                            class="btn btn-primary">Book Now</a></div>
